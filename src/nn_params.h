...
extern const float net_0_bias_scale;
extern const int fxp_net_0_bias_scale;
extern const float net_0_wx_scale[64];
extern const int fxp_net_0_wx_scale[64];
extern const float net_0_input;
extern const int fxp_net_0_input;
extern const float net_2_bias_scale;
extern const int fxp_net_2_bias_scale;
extern const float net_2_wx_scale[32];
extern const int fxp_net_2_wx_scale[32];
extern const float net_2_input;
extern const int fxp_net_2_input;
extern const float net_4_bias_scale;
extern const int fxp_net_4_bias_scale;
