...
def run_mlp(x, c_lib):
    ...
    c_run_mlp.argtypes = (c_float_p, ctypes.c_uint, c_uint_p)
    c_run_mlp.restype = None
    c_run_mlp(x.ctypes.data_as(c_float_p), ctypes.c_uint(N), 
